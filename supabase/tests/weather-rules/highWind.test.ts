...
// WIND_THRESHOLD_KPH = 40; scans the whole forecast window and groups windy days.
// today = "2026-05-01"; default maxWindKph = 15
...
Deno.test("highWind — looks ahead across the window (a windy day 3 days out still alerts)", () => {

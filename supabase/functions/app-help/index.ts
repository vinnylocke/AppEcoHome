...
## Integrations
SECTION[integrations-overview]: Integrations connect physical IoT devices to your Rhozly home. Supported: Ecowitt soil sensors (temperature, moisture, EC) and eWeLink smart water valves (remote on/off with auto-off timer).
SECTION[integrations-connect]: To connect a device: go to the Integrations section (accessible from Management or the nav), tap "Connect Device", choose the device type (soil sensor or water valve), follow the wizard to enter your device credentials, and Rhozly will sync data automatically.

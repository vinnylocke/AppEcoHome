...
export const APP_FACTS: string[] = [
  ...
  "  - PLANNING: the Planner builds multi-phase plans (AI can shape them); seasonal planting guidance is hemisphere-aware. Shopping lists for plants and supplies exist as their own feature — adding a plan's needs to a list is currently a manual step (don't claim plans auto-build shopping lists).",

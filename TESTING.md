...
### E2E tests — 556 tests across 38 files (+ 13 isolation tests)
...
| `shed-crud.spec.ts` | 34 | Add plant (manual + AI), edit, archive, restore, delete, search/filter, detail drawer; + Stage 2 takeover (SHED-TKO-001/002) + Stage 3 landing (SHED-S3-001 escalation row, SHED-S3-002 persona browse chips) |

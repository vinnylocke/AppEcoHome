...
### Unit tests — 1,614 tests across 151 files
...
### E2E tests — 572 tests across 38 files (+ 13 isolation tests)
...
| `shed-crud.spec.ts` | 38 | Add plant (manual + AI), edit, archive, restore, delete, search/filter, detail drawer; + search overlay (SHED-TKO-001/002/003 — deep link, back, keyboard-safe top bar + Escape ladder) + Stage 3 landing (SHED-S3-001 escalation row, SHED-S3-002 persona browse chips); v3 feedback polish (2026-07-22): SHED-P1 "N past" chip, SHED-P2 visibility-law hidden hint |

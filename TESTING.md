...
### E2E tests — 554 tests across 38 files (+ 13 isolation tests)
...
| `shed-crud.spec.ts` | 32 | Add plant (manual + AI), edit, archive, restore, delete, search/filter, detail drawer; + Stage 2 takeover (SHED-TKO-001 deep-link into the full-page search, SHED-TKO-002 back-to-grid) |

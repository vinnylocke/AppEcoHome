...
| `watchlist.spec.ts` | 33 | Ailment list, type filters, add manual/AI, detail modal tabs, archive/restore/delete; + search overlay (WL-TKO-001 open/back, WL-TKO-002 ?open=add-ailment deep link, WL-TKO-003 keyboard-safe input + row-tap → field-guide detail parity); v3 feedback polish (2026-07-22): rebrand to Binoculars/watchlist voice, card-kebab archive/delete, merged Watchlist chip, WL-P1 visibility-law hidden hint |

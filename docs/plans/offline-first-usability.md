...
- **Routine editing** (existing blueprint) and **task-dependency linking** stay online-only — they touch already-materialised rows / need ghost materialisation. Creating a *new* routine is what goes offline.

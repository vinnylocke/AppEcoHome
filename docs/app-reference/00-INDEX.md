...
- [x] [Home (Main Dashboard)](./02-dashboard/17-home-main.md) — the single `/dashboard` view — Simple/Detailed density, Overview merged in (Phase 4.2): status strip or Daily Brief hero, garden overview grid, quick actions, Garden Walk launcher, compact or full task list, Garden Snapshot stat wall (Detailed), single-slot onboarding

...
5. **User clicks Refresh.** Calls `manual-refresh-ai-plant` against the global. Toast reports either "Care guide is up to date" or the refreshed field count. 7-day local + edge rate-limit per (user, plant).

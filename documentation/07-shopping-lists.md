...
The list moves to the **Completed** section at the bottom of the page.

---

## Reopening a Completed List

Expand the **Completed** section → tap **Reopen** on any completed list. It returns to active status.

...
The **Shed** is your master plant library. It lives under the **Plants** tab in the sidebar. Every plant in your garden — whether you added it manually, found it through the database search, or had it identified by AI — lives here.

![The Shed showing a grid of plant cards with thumbnails, names, and source badges](/doc-images/05-the-shed-01-grid.webp)

---

## The Shed, Watchlist & Senescence

The **Plants** tab has these sub-tabs at the top:

| Tab | What's here |
|-----|-------------|
| **Plants** | Your plant inventory (the Shed) — all species and instances you're growing |
| **Watchlist** | Tracked ailments (pests, diseases, invasive plants) — see [Ailment Watchlist](./11-ailment-watchlist.md) |
| **Senescence** | Plants nearing the end of their life-cycle, flagged for review |

A **Plants / Nursery** toggle in the page header switches between your inventory and your seed packets / sowings — see [Nursery & Sowing](./21-nursery-and-sowing.md). (Notes have their own **Notes** tab in the sidebar — see [Notes](./16-notes.md).)
...
**Filter by source:**
- **All Sources** — show every plant
- **Manual** — only plants you created by hand
- **Plant Database** — plants found via a plant database (Perenual / Verdantly / Pl@ntNet)
...
![Plant detail view showing the plant image, name, all instances listed by area, and the care routine card](/doc-images/05-the-shed-05-plant-detail.webp)

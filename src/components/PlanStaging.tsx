...
const WikiPlantCard = ({
  ...
  const [isExpanded, setIsExpanded] = useState(false); // 🚀 NEW: State for Read More toggle
  ...
  useEffect(() => {
    ...
    const fetchInfo = async () => {
      try {
        // If you are importing this from lib/wikipedia, ensure it is imported at the top of your file!
  ...
  return (
    <div className="p-5 border border-emerald-100 rounded-2xl bg-white shadow-sm hover:shadow-md transition-shadow flex flex-col gap-4 animate-in fade-in">
      ...
      <div className="flex justify-between items-start gap-3">
        ...
        {/* Delete Button safely positioned */}
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          {/* Wikipedia Description with Read More */}
          {wikiData.extract && (
            <div>
              <p

  ...
  const handleComplete = async () => {
    ...
    try {
      const profile: UserProfile = {
        uid: user.id,
        email: user.email || "",
        display_name: user.user_metadata?.full_name || "Gardener",
        mode,
        onboarded: true,
        notification_interval_hours: 8,
      };
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          >
            <BookOpen
              className={
                mode === "Novice" ? "text-emerald-600" : "text-stone-400"
              }
              size={24}
            />
            <div>
              ...
              <p className="text-sm text-stone-500">
                Simple tips, easy-to-follow guides, and common names.
              </p>
            </div>
          </button>
          ...
          >
            <GraduationCap
              className={
                mode === "Expert" ? "text-emerald-600" : "text-stone-400"
              }
              size={24}
            />
            <div>
              ...
              <p className="text-sm text-stone-500">
                Scientific names, data-heavy insights, and technical care.
              </p>
            </div>
          </button>
        </div>
